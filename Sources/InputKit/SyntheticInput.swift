...
public enum SyntheticInput {
    ...
    public static func post(_ chord: KeyChord) -> Bool {
        ActivityMonitor.shared.withOwnedInput(kind: .keyboard, toolName: "SyntheticInput.post") {
    ...
    public static func click(x: Double, y: Double, rightButton: Bool, clickCount: Int) -> Bool {
        ActivityMonitor.shared.withOwnedInput(kind: .mouse, toolName: "SyntheticInput.click") {
            let source = CGEventSource(stateID: .hidSystemState)
    ...
    public static func scroll(dx: Int, dy: Int) -> Bool {
        ActivityMonitor.shared.withOwnedInput(kind: .mouse, toolName: "SyntheticInput.scroll") {
            let source = CGEventSource(stateID: .hidSystemState)
    ...
    public static func move(x: Double, y: Double) -> Bool {
        ActivityMonitor.shared.withOwnedInput(kind: .mouse, toolName: "SyntheticInput.move") {
            let source = CGEventSource(stateID: .hidSystemState)
    ...
    public static func drag(fromX: Double, fromY: Double, toX: Double, toY: Double, steps: Int = 12) -> Bool {
        ActivityMonitor.shared.withOwnedInput(kind: .mouse, toolName: "SyntheticInput.drag") {
            let source = CGEventSource(stateID: .hidSystemState)
    ...
    public static func typeUnicode(_ text: String) -> Int {
        ActivityMonitor.shared.withOwnedInput(kind: .keyboard, toolName: "SyntheticInput.typeUnicode") {
            let source = CGEventSource(stateID: .hidSystemState)
            var posted = 0
    ...
    public static func paste(_ text: String, consumed: (@Sendable () -> Bool)? = nil) -> PasteOutcome {
        ActivityMonitor.shared.withOwnedInput(kind: .keyboard, toolName: "SyntheticInput.paste") {
            pasteLock.lock()
